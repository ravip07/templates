      ...
      swiperSlide.end()
        ...
        .swiper({
          ...
          paginationBulletRender: pag.length ? pag.attr("data-index-bullet") === "true" ? function (index, className) {
            return '<span class="' + className + '"><span class="number">'+ (index + 1) +'</span><svg class="svg-bullet" x="0px" y="0px" width="39px" height="36px" viewBox="0 0 39 36"><path d="M32.997,11.262c-0.539,0-1.059,0.08-1.553,0.223c0.317-0.355,0.598-0.751,0.824-1.195 c1.417-2.78,0.311-6.183-2.469-7.599l-2.544-1.296c-2.78-1.417-6.183-0.311-7.599,2.469c-0.104,0.204-0.19,0.412-0.267,0.621 c-0.095-0.319-0.215-0.634-0.372-0.94c-1.39-2.728-4.729-3.813-7.457-2.423L9.063,2.393C6.335,3.784,5.25,7.122,6.64,9.85 c0.179,0.352,0.392,0.675,0.63,0.97c-0.355-0.071-0.722-0.109-1.098-0.109c-3.078,0-5.574,2.495-5.574,5.574v2.817 c0,3.078,2.495,5.574,5.574,5.574c0.337,0,0.665-0.035,0.985-0.092c-0.355,0.378-0.666,0.808-0.913,1.294 c-1.408,2.762-0.309,6.143,2.453,7.55l2.528,1.288c2.762,1.407,6.143,0.309,7.55-2.453c0.122-0.239,0.218-0.484,0.303-0.731 c0.097,0.343,0.227,0.682,0.395,1.012c1.39,2.728,4.728,3.813,7.456,2.423l2.496-1.272c2.728-1.39,3.813-4.728,2.423-7.456 c-0.26-0.51-0.588-0.963-0.968-1.352c0.653,0.266,1.366,0.416,2.115,0.416c3.095,0,5.603-2.509,5.603-5.603v-2.832 C38.6,13.771,36.091,11.262,32.997,11.262z"/></svg></span>';
          } : null : null,
